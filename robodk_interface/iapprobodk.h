...
public:
    ...
    virtual QString PluginLoad(QMainWindow *mw, QMenuBar *menubar, QStatusBar *statusbar, IRoboDK *rdk, const QString &settings=""){ Q_UNUSED(mw) Q_UNUSED(menubar) Q_UNUSED(statusbar) Q_UNUSED(rdk) Q_UNUSED(settings) return ""; }
    ...
    virtual void PluginLoadToolbar(QMainWindow *mw, int iconsize){ Q_UNUSED(mw) Q_UNUSED(iconsize) }
    ...
    /// \return
    virtual bool PluginItemClick(Item item, QMenu *menu, TypeClick click_type){ Q_UNUSED(item) Q_UNUSED(menu) Q_UNUSED(click_type) return false; }
    ...
    /// \param value
    /// \return
    virtual QString PluginCommand(const QString &command, const QString &value){ Q_UNUSED(command) Q_UNUSED(value) return ""; }
    ...
    virtual void PluginEvent(TypeEvent event_type){ Q_UNUSED(event_type) };
    ...
    /// \param click_type Click type (usually left click)
    /// \return
    virtual bool PluginItemClickMulti(QList<Item> &item_list, QMenu *menu, TypeClick click_type){ Q_UNUSED(item_list) Q_UNUSED(menu) Q_UNUSED(click_type) return false; }
